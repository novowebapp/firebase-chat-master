...
import static com.crazyhitty.chdev.ks.firebasechat.ui.fragments.RegisterFragment.apelido;
...
public class MyFirebaseInstanceIDService extends FirebaseInstanceIdService {
    ...
    private void sendRegistrationToServer(final String token) {
        ...
        new SharedPrefUtil(getApplicationContext()).saveString(Constants.ARG_APELIDO, apelido);
